...
import AllSplashersView from './views/AllSplashersView/AllSplashersView';
...
import GuidesView from './views/guides/content/GuidesView';
import NormalKnightGuide from './views/guides/content/NormalKnightGuide';
import StickyKnightGuide from './views/guides/content/StickyKnightGuide';
import PluginGuide from './views/guides/content/PluginGuide';
import PickpocketGuide from './views/guides/content/PickpocketGuide';
import OptimalSetupGuide from './views/guides/content/OptimalSetupGuide';
import MobileSetupGuide from './views/guides/content/MobileSetupGuide';
import SoloSetupGuide from './views/guides/content/SoloSetupGuide';
